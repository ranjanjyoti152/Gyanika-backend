...
export default function Playground({
  ...
  useEffect(() => {
    if (roomState === ConnectionState.Connected && room.localParticipant) {
      room.localParticipant.setCameraEnabled(config.settings.inputs.camera);
      room.localParticipant.setMicrophoneEnabled(config.settings.inputs.mic);
    }
